...
public class DefaultFSTInt2ObjectMap<V> implements FSTInt2ObjectMap <V>{
    ...
    public void clear() {
        ...
        if (mKeys.length > 6 * size() && size > 0) {
            ...
            mNumberOfElements = 0;
//       
            next = null; // 257mod1-jdk17 Resolves issue 323 https://github.com/RuedigerMoeller/fast-serialization/pull/324
//            next.clear();
        } else {
            FSTUtil.clear(mKeys);
        ...
        //https://github.com/RuedigerMoeller/fast-serialization/pull/280/files#diff-10ddad84a9b815859de5b1e666b80389823cac03bb2a5d60d97fd2bfc22cc49f
        // could possibly resolve issue 323 also (?) needs the test from 323
            if (next != null) {
                next.clear();
