...
//        if (ser == null) { //https://github.com/RuedigerMoeller/fast-serialization/pull/311/files
...
if (serializer == null) {
        ...
        //}//https://github.com/RuedigerMoeller/fast-serialization/pull/311/files
        ser = serializer;
        } else if (serializer == FSTSerializerRegistry.NULL) {
//        if (ser == FSTSerializerRegistry.NULL) {//https://github.com/RuedigerMoeller/fast-serialization/pull/311/files
            return null;
        }
//        return ser;//https://github.com/RuedigerMoeller/fast-serialization/pull/311/files
        return serializer;
    }
